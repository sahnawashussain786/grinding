              ...
              <div className="bg-slate-50 p-10 rounded-3xl shadow-xl">
                ...
                {submitted ? (
                  <div className="bg-green-100 border border-green-200 rounded-2xl p-8 text-center">
                    <div className="text-green-600 text-2xl font-bold mb-4">Thank you! Your message has been sent!</div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button type="submit" className="w-full bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 text-white py-4 px-8 rounded-2xl font-bold text-xl transition-all hover:scale-105 shadow-lg shadow-orange-500/30">
                      Send Message
                    </button>
                  </form>
                )}
